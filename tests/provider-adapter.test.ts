...
describe('ProviderAdapter - Warning Messages', () => {
    test('should warn when Anthropic config provided without API key', () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('Anthropic provider config provided but API key is missing');
        consoleSpy.mockRestore();
    });
    ...
    test('should warn when OpenAI config provided without API key', () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('OpenAI provider config provided but API key is missing');
        consoleSpy.mockRestore();
    });
    ...
    test('should warn when Gemini config provided without API key', () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('Gemini provider config provided but API key is missing');
        consoleSpy.mockRestore();
    });
    ...
    test('should warn when Tavily config provided without API key', () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('Tavily provider config provided but API key is missing');
        consoleSpy.mockRestore();
    });
    ...
    test('should warn when WhoisXML config provided without API key', () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('WhoisXML provider config provided but API key is missing');
        consoleSpy.mockRestore();
    });
});