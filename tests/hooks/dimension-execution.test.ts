...
describe('Provider Execution Hooks', () => {
    ...
    describe('beforeProviderExecute', () => {
        ...
        test('should add metadata to request', async () => {
            ...
            expect(mockProvider.receivedRequests[0]?.metadata?.customId).toBe('req-123');
            expect(mockProvider.receivedRequests[0]?.metadata?.timestamp).toBeDefined();
        });
        ...
        test('should receive complete context', async () => {
            ...
            await engine.process([{ content: 'Test content', metadata: { id: '123' } }]);
    ...
    describe('afterProviderExecute', () => {
        ...
        test('should modify response after provider execution', async () => {
            ...
            expect(result.sections[0]?.results.test?.data?.originalResult).toBeDefined();
        });
        ...
        test('should modify metadata in response', async () => {
            ...
            expect(result.sections[0]?.results.test?.metadata?.processingTime).toBeDefined();
        });
        ...
        test('should filter response data', async () => {
            ...
            expect(result.sections[0]?.results.test?.data?.requestInput).toBeUndefined();
        });
        ...
        test('should work with both before and after hooks', async () => {
            ...
            expect(mockProvider.receivedRequests[0]?.input).toBe('modified by before');
