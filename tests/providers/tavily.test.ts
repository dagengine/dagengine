...
describe('TavilyProvider', () => {
  ...
  test('should return metadata with results', async () => {
    const mockResponse = {
      results: [
        { title: 'R1', url: 'https://example.com/1', content: 'C1', score: 0.9 },
        { title: 'R2', url: 'https://example.com/2', content: 'C2', score: 0.8 }
      ]
    };
  ...
  test('should aggregate results from multiple queries', async () => {
    const mockResponse1 = {
      results: [{ title: 'R1', url: 'https://ex.com/1', content: 'C1', score: 0.9 }]
    };
    const mockResponse2 = {
