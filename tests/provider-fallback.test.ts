...
describe('DagEngine - Provider Fallback', () => {
    ...
    test('should use primary provider when it succeeds', async () => {
        ...
        // ✅ Type-safe access
        const analysisData = result.sections[0]?.results?.analysis?.data as ProviderTestResponse;
    ...
    test('should handle per-dimension different fallback strategies', async () => {
        ...
        const analysis1Data = result.sections[0]?.results?.analysis1?.data as ProviderTestResponse;
        const analysis2Data = result.sections[0]?.results?.analysis2?.data as ProviderTestResponse;
    ...
    test('should work with global dimensions', async () => {
        ...
        const globalData = result.globalResults.global_analysis?.data as ProviderTestResponse;
