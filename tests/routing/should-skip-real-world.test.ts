...
describe('Routing - Real-World Document Processing', () => {
    ...
    test('should efficiently process mixed document types with smart routing', async () => {
        ...
        const sentimentAnalyses = mockProvider.getDimensionCallCount('analyze_sentiment');
        const entityExtractions = mockProvider.getDimensionCallCount('extract_entities');
        const classifications = mockProvider.getDimensionCallCount('classify_document');
    ...
    test('should demonstrate cost savings with smart routing', async () => {
        ...
        const savings = ((callsWithoutRouting - callsWithRouting) / callsWithoutRouting) * 100;
