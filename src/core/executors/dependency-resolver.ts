...
import { DimensionResult, DimensionDependencies } from '../../types.ts';
    ...
    async resolveGlobalDependencies(
        ...
        for (const depName of dimensionDeps) {
            ...
            dependencies[depName] = this.plugin.isGlobalDimension(depName)
                ...
                : this.resolveSectionDependencyForGlobal(depName, sectionResultsMap, totalSections);
        }
