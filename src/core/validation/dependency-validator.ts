...
export class DependencyValidator {
    ...
    static validate(
        ...
        this.validateDependenciesExist(dimensions, dependencyGraph);
        this.validateNoCycles(dependencyGraph);
        this.validateGlobalDependencies(dependencyGraph, plugin);
    }
    ...
    private static validateGlobalDependencies(
        ...
        for (const dimension of dimensions) {
            ...
            if (!isGlobal) {
                // Section dimensions can depend on globals or other sections
    ...
    static dependsOn(
        ...
        const allDeps = this.getAllDependencies(dimension, dependencyGraph);
